          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Heures contractuelles hebdomadaires (en minutes) *</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        {...field}
                    ...
                    <FormDescription>
                      Valeur actuelle: {convertMinutesToHours(field.value || 0)}
                      <br />
                      Minimum: 5h (300 min), Maximum: 40h (2400 min)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Heures maximales journalières (en minutes)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Nombre maximum de cours consécutifs</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        {...field}
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">Multi-sites</FormLabel>
                      <FormDescription>
